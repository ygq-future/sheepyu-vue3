...
import static top.sheepyu.framework.sms.core.constants.SmsSenderConstants.SMS_CODE_KEY;
import static top.sheepyu.framework.sms.core.constants.SmsSenderConstants.SMS_CODE_TTL;
...
public class EmailSmsSender implements SmsSender {
    ...
    public String getType() {
        return SmsTypeEnum.EMAIL.getCode();
    }
}
